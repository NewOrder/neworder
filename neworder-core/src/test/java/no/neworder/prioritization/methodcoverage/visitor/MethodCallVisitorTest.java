...
import no.neworder.prioritization.methodcoverage.model.RawMethodCall;
import no.neworder.prioritization.methodcoverage.model.ReferenceType;
...
public class MethodCallVisitorTest {
	...
	public void setup() throws FileNotFoundException, ParseException {
		FileInputStream fis = new FileInputStream("src/main/java/no/neworder/prioritization/methodcoverage/visitor/MethodCallVisitor.java");
