...
package no.neworder.prioritization.methodcoverage.visitor;

import japa.parser.JavaParser;
import japa.parser.ParseException;
import japa.parser.ast.CompilationUnit;
import no.neworder.prioritization.methodcoverage.model.*;
...
public class MethodCoverageVisitorTest {
    ...
    public void setup_MethodDeclarationVisitor_test_object() throws FileNotFoundException, ParseException {
        FileInputStream fis = new FileInputStream("src/main/java/no/neworder/prioritization/methodcoverage/visitor/MethodDeclarationVisitor.java");
		CompilationUnit cu = JavaParser.parse(fis);

        Map<String, ClassType> classesInProject = new HashMap<String, ClassType>();

        ClassType callingClass = new ClassType("no.neworder.prioritization.methodcoverage.visitor", "MethodDeclarationVisitor", null);
        ...
        ClassType thirdClass = new ClassType("no.neworder.prioritization.methodcoverage.visitor", "ReturnTypeVisitor", null);
    ...
    public void should_include_methods_called_by_field_variables() throws ParseException, FileNotFoundException {
    	FileInputStream fis = new FileInputStream("src/test/java/no/neworder/prioritization/methodcoverage/visitor/MethodCoverageVisitorTest.java");
		CompilationUnit cu = JavaParser.parse(fis);
		
		Map<String, ClassType> classesInProject = new HashMap<String, ClassType>();
		
		ClassType classCoverClass = new ClassType("no.neworder.prioritization.methodcoverage.model", "ClassCover", null);
        ...
        ClassType theTestClass = new ClassType("no.neworder.prioritization.methodcoverage.visitor", "MethodCoverageVisitorTest", null);
    ...
    public void should_support_overloaded_method_declarations() throws FileNotFoundException, ParseException {
    	FileInputStream fis = new FileInputStream("src/main/java/no/neworder/prioritization/methodcoverage/visitor/MethodCoverageVisitor.java");
		CompilationUnit cu = JavaParser.parse(fis);
