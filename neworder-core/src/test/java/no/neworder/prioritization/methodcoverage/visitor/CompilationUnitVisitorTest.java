...
import no.neworder.prioritization.methodcoverage.model.ClassType;
import no.neworder.prioritization.methodcoverage.model.MethodDecl;
...
public class CompilationUnitVisitorTest {
	...
	public static void setup_class() throws FileNotFoundException, ParseException {
		FileInputStream fis = new FileInputStream("src/main/java/no/neworder/prioritization/methodcoverage/visitor/CompilationUnitVisitor.java");
	...
	public void should_integrate_with_ClassOrInterfaceDeclarationVisitors_package_name() {
		...
		assertThat(types.get(0).getPackageName(), is(equalTo("no.neworder.prioritization.methodcoverage.visitor")));
	}
	...
	public void should_retrieve_import_statements() {
		...
		assertThat(imports, hasItems(
				"no.neworder.prioritization.methodcoverage.model.ClassType",
	...
	public void should_get_package_name() {
		...
		assertThat(packageName, is(equalTo("no.neworder.prioritization.methodcoverage.visitor")));
	}
